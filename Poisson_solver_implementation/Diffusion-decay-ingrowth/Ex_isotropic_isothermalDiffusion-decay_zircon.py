...
Temp = uw.options.getReal(name='temp', default = 780) ### C
...
outputPath = f'./output/isotropic_isothermal_temp={Temp}_duration={model_duration}_csize={csize}_Diffusion-Decay_test/'
...
# plt.savefig(f'{outputPath}isotropic_diffusion-decay-U_Pb_profiles-{Temp}C_{model_duration}Myr_csize={csize}.pdf')
